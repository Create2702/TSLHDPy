...
* **5 step**: Enter the date and number of the weather station. (Example station number: 27995)
* **6 step**: Confirm the date to receive the sounding.
* **7 step**: After that, a window will open with the sensing data shown on the Skew-T diagram, hodograph and tabular data.
### Notes
___
...
```python
pip install matplotlib metpy siphon requests numpy
```
